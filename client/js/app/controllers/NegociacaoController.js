class NegociacaoController{
    constructor(){
        ...
        /*
        this._listaNegociacoes = new ListaNegociacoes(model=>this._negociacoesView.update(model)); //instacio a classe listaNegociacoes passando como parametro a funcao que pega a view de negociacoes e atualiza
        */
